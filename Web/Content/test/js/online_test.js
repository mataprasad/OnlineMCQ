...
function submit_test(malpractice) {
    ...
    var test_id = $.trim($('#quiz_id').text()); //window.location.pathname.split("/")[2];
    ...
    var post_data_obj = { csrfmiddlewaretoken: csrf, questions: questions, total_time_spent: total_time_spent, test_id: test_id, attempt_id: attempt_id, sections: sections };
    var dataString = JSON.stringify(post_data_obj);
